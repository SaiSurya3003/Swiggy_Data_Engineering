...
from (
    ...
    from @stage_sch.csv_stg/initial/customer_address_book/customer_address_book_initial.csv t
)
...
from (
    select 
        ...
        metadata$file_content_key as _stg_file_md5,
        current_timestamp as _copy_data_ts
    -- from @stage_sch.csv_stg/delta/customer_address/day-01-customer-address-book.csv t
