...
-- to remove the invalid data from the Location Table and Location Stream Tabel
create temp table common.location_tmp as
select * from stage_sch.location_stm;
delete from stage_sch.location where locationid like '%|%';

-- run from the First Merge statement again to Load the Updated Data into the Clean_Sch Location table and the Stream table