...
from (
    ...
    from @stage_sch.csv_stg/initial/order_item/order-Item-initial.csv t
    -- from @stage_sch.csv_stg/initial/order_item/order-item-initial-v2.csv t
)
...
-- part-2
list @stage_sch.csv_stg/delta/order_item/;
...
from (
    select 
        ...
        metadata$file_content_key as _stg_file_md5,
        current_timestamp as _copy_data_ts
    from @stage_sch.csv_stg/delta/order_item/ t
)
file_format = (format_name = 'stage_sch.csv_file_format')
on_error = abort_statement;